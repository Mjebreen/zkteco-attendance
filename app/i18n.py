...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "calendar": "Calendar",
        "calendar_hint": "Click a day to mark it as a day off, online or a working day, or to move a day off within the week.",
    ...
    "ar": {
        ...
        "online_day": "عن بُعد",
        "working_day": "يوم عمل",
        "worked_day_off": "حضر في يوم إجازته",
        "schedule": "الجدول",
        "weekly_pattern": "النمط الأسبوعي",
        "weekly_hint": "يتكرر كل أسبوع. أي تغيير في التقويم أدناه له الأولوية في ذلك التاريخ.",
        "calendar": "التقويم",
        "calendar_hint": "اضغط على أي يوم لتحديده كإجازة أو عمل عن بُعد أو يوم عمل، أو لنقل الإجازة داخل الأسبوع.",
        "auto_follow": "تلقائي (حسب النمط الأسبوعي)",
        "move_day_off": "نقل هذه الإجازة إلى",
        "move": "نقل",
        "note": "ملاحظة",
        "cancel": "إلغاء",
        ...
        "bulk_weekly_hint": "مثال: كل جمعة إجازة للجميع. يمكن تعديل كل موظف على حدة من صفحته.",
